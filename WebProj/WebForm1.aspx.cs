...
namespace WebApplication1Lab.Controllers
{
    ...
    {
        SoundPlayer splayer = new SoundPlayer(@"D:/FCIS 2024/WebProject1/WebProj/SFX/Sound.wav");
        ...
        protected void UploadBtn_Click(object sender, EventArgs e)
        {
            ...
            if (FileUpload1.HasFile)
            {
                ...
                {
                    FileUpload1.SaveAs("D:/FCIS 2024/WebProject1/WebProj/Media/" + FileUpload1.FileName);
